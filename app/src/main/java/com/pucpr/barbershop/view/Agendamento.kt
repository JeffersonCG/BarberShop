package com.pucpr.barbershop.view
...
import com.pucpr.barbershop.databinding.ActivityAgendamentoBinding
...
class Agendamento : AppCompatActivity() {
        ...
        binding.btAgendar.setOnClickListener {
            ...
            when{
                ...
                hora < "8:00" && hora > "19:00" -> {
                    mensagem(it, "Estabelecimento fechado - Horario de atendimento das 08:00 as 19:00","#FF0000")
                }
                data.isEmpty() -> {
                    mensagem(it, "Preencha uma data","#FF0000")
                }
    ...
    /*private fun salvarAgendamento (view: View,cliente: String, barbeiro: String, data: String, hora: String){
        ...
        val db = FirebaseFirestore.getIbstance()
        ...
        db.collection("agendamento").document(cliente).set(dadosUsuario).addPnCompleteListener{
            mensagem(view,"Agendamento realizado com successo","#FFFFFF")
        }.addonFailureListener{
            mensagem(view, "Erro no servidor", "#FFFFFF")
        }*/
